...
class FirstComeFirstServedTest : public ::testing::Test
{
protected:
...
// Test case for first_come_first_served::run() method
TEST_F(FirstComeFirstServedTest, RunTest)
{
    ...
    // Call the run() method
    cse4733::first_come_first_served::run(processes);

    // Verify the final state of process1
    ...
    // Verify the final state of process2
    ...
    // Verify the final state of process3
...
// Test case for first_come_first_served::run() method
TEST_F(FirstComeFirstServedTest, RunTest3)
{
    int completionTime1 = 10;
    int burstTime1 = 10;
    int arrivalTime1 = 0;
    int turnaroundTime1 = completionTime1 - arrivalTime1;
    int waitingTime1 = turnaroundTime1 - burstTime1;
